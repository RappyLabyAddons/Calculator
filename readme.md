...
3. It should open your Labymod addon directory; Paste the [Calculator.jar](https://github.com/RappyLabyAddons/Calculator/releases/download/v1.1.0/Calculator.jar) in there.
